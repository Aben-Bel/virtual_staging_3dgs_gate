...
const en = {
  ...
  config: {
    ...
    layoutLabel: 'Furniture & positions',
    layoutPlaceholder: 'Describe the furniture and where things go…',
    assetsLabel: 'Reference items',
    addAsset: '+ Add reference image',
    assetNotePlaceholder: 'Placement note (optional)',
    assetsHint: 'These images are sent with the venue so the model places them inside.',
    themeLight: 'Light',
    themeDark: 'Dark',
  },
  connectivity: {
...
const de: Dict = {
  ...
  config: {
    ...
    tabStyle: 'Stil',
    tabFurniture: 'Möblierung',
    layoutLabel: 'Möbel & Positionen',
    layoutPlaceholder: 'Beschreibe die Möbel und wohin sie gehören…',
    assetsLabel: 'Referenzobjekte',
    addAsset: '+ Referenzbild hinzufügen',
    assetNotePlaceholder: 'Platzierungshinweis (optional)',
    assetsHint: 'Diese Bilder werden mit dem Raum gesendet, damit das Modell sie darin platziert.',
    themeLight: 'Hell',
    themeDark: 'Dunkel',
  },
  connectivity: {
